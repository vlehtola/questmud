 ...
 switch (sizeof(args))
	{
	 ...
	 case 4	:	result = call_other(target, fun, args[0], args[1], args[2], args[3]); 
			break;
	 case 5	:	result = call_other(target, fun, args[0], args[1], args[2], args[3], args[4]); 
			break;
	 case 6	:	result = call_other(target, fun, args[0], args[1], args[2], args[3], args[4], args[5]); 
			break;
	 case 7	:	result = call_other(target, fun, args[0], args[1], args[2], args[3], args[4], args[5], args[6]); 
			break;
	 case 8	:	result = call_other(target, fun, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7]); 
			break;
	 case 9	:	result = call_other(target, fun, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]); 
			break;
	 case 10:	result = call_other(target, fun, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9]); 
			break;
	 default : break;
	}
