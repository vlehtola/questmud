// Lottery-Office for QuestMUD by Astarel
//   Inspired by the Real-life-lottery winning(small one)
//   i decided code this lottery-office to QuestMUD so everyone
//   can have a change to get that glorious feeling you get
//   when you win in lottery.

//   It randomly picks 7 numbers between 1 and LOTTO_MAXNUM
//   and compares those numbers to the values of mapping which
//   stores the ticket-owners and ticket-numbers. you need
//   to have 5 or more right to get some win, more you have
//   more money you'll get.

//   It uses save_object() and restore_object() functions to
//   save the data through boots. I tried to hunt down all
//   possible bugs, abuseholes and other features i could.

// 30.1.2002: Astarel
//            - Coded the first (and maybe the last)
//              version of this lottery-thingie.
//            - Im tired as hell and i just find out that
//              my english sucks. Off to sleep.
...
mapping temp_map;
	...
	if((this_player()->total_money()/100) < LOTTO_TICKET_COST) {
        ...
        if(sscanf(arg,"ticket %d %d %d %d %d",i1,i2,i3,i4,i5) != 5) {
        write("Syntax: buy ticket Num1 Num2 Num3 Num4 Num5\n");
        return 1;
        }
