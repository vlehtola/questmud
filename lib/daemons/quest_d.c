...
case "Help the historian": return 2; 
// /wizards/kaappi/dcity/mobs/historian.c
case "Help the Baker in Amaranthgard": return 3;
// /wizards/kaappi/dcity/mobs/leipuri.c
case "Conciliate Boltak": return 3;
// /wizards/kaappi/dcity/mobs/boltak.c 3qp
