...
/* Added 2nd rebirth races -- Rag 25.2.2004 */
/* 3rd rebirth race -- Rag 1.6.2004 */
...
reset(arg) {
  ...
  races += ([ "sprite":     ({"high", "spec","30", "90", "60", "90", "75", "very small","high", "high","90","high","foresee attack",}) ]);

  /* REBIRTH 2 RACES */
  
  races += ([ "demon":      ({"spec", "med", "90", "60", "90", "45", "45", "huge",      "spec", "med","90", "high", "tremendous blow", }) ]);
  races += ([ "spirit":     ({"med", "spec", "45", "60", "60", "90", "90", "large",     "med", "spec","90", "high", "cast storm", }) ]);

  /* REBIRTH 3 RACE */
  
  races += ([ "avatar":     ({"spec", "spec", "75", "90", "75", "75", "90", "huge",    "ulspec", "ulspec","10","high", "reflect spell", }) ]);
...
change_adj(string str, int alt) {
  ...
  case "ulspec": return "extremely slowly";
  }
  }
  switch(str) {
