...
reset(arg) {
  ...
  races += ([ "sprite":     ({"high", "very high","30", "90", "60", "90", "75", "very small","high", "high","90","high","foresee attack",}) ]);
  ...
  //races += ([ "avatar":     ({"spec", "spec", "90", "75", "90", "75", "90", "huge",    "spec", "spec","80","high", "reflect spell", }) ]);
