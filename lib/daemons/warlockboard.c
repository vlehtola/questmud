...
#define HRSTR "------------------------------------------------------------------------------\n"
#define SAVEFILE "/data/warlockboard"
...
short() {
    return ("A warlock bulleting board");
}
...
write("'board list'             - a list of threads\n");
