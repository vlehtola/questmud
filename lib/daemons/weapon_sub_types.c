...
if(type == "small shield") return 4;
  ...
  if(type == "knuckles {White}") return 5; /*White*/
  if(type == "knuckles {Yellow}") return 5; /* yellow */
  if(type == "knuckles {Green}") return 5; /*green*/
  if(type == "knuckles {Blue}") return 5; /*blue*/
  if(type == "knuckles {Red}") return 5; /*red*/
  if(type == "knuckles {Black}") return 5; /*1.Dan*/
  if(type == "knuckles {*BLACK*}") return 5; /*9.dan*/
...
reset(arg) {
  ...
  dam_types += (["knuckles {White}":"40 60 0"]);
  dam_types += (["knuckles {Yellow}":"50 50 0"]);
  dam_types += (["knuckles {Green}":"40 60 0"]);
  dam_types += (["knuckles {Blue}":"50 50 0"]);
  dam_types += (["knuckles {Red}":"40 40 20"]);
  dam_types += (["knuckles {Black}":"30 70 0"]);
  dam_types += (["knuckles {*BLACK*}":"50 50 0"]);
  /* hb [-2,2] , db [1,9]. */
  ...
  bonuses += (["knuckles {White}":"2 1"]);
  bonuses += (["knuckles {Yellow}":"0 2"]);
  bonuses += (["knuckles {Green}":"1 3"]);
  bonuses += (["knuckles {Blue}":"1 5"]);
  bonuses += (["knuckles {Red}":"0 6"]);
  bonuses += (["knuckles {Black}":"-1 7"]);
  bonuses += (["knuckles {*BLACK*}":"-2 9"]);
