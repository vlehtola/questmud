...
reset(arg) {
  if(arg) return;
  add_exit("north","wizards/nalle/jerusalem/sewc1");
  add_exit("east","wizards/nalle/jerusalem/sewd2");
  add_exit("west","wizards/nalle/jerusalem/sewb2");
...
"rodents. You think you could be under the eastern part of the town.\n";
