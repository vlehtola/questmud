...
add_exit("north","/guilds/abjurer/abjurers.c");
add_exit("south","/guilds/abjurer/corridor.c");
add_exit("east","/guilds/abjurer/stairs2.c");
add_exit("west","/guilds/abjurer/stairs3.c");
...
"marble hall is in the centre of the tower, towards north.\n";
