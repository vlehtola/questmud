...
add_exit("south","/guilds/abjurer/corridor4.c");
add_exit("east","/guilds/abjurer/corridor2.c");
add_exit("up","/guilds/abjurer/stairs8.c");

short_desc = "A small hall on the first floor of the tower";
long_desc =
"Silver spiral stairs are in the middle of this small hall, which is located\n"+
