...
add_exit("down","/guilds/abjurer/stairs2.c");
...
"walls light the stairs and the walls perfectly. The top of the\n"+
"tower has collapsed and it is impossible to go any further.\n";
