...
//Sorcerer juttui moonstar&rimber
  case "ixi": return "cast will";
  case "mza": return "cast minor ztrand";
  case "ztr": return "cast ztrand";
  case "zma": return "cast major ztrand";
  case "wod": return "cast wounding";
  case "sch": return "cast soul chaining";
