...
tell_object(caster_ob, "You call the void and receive a chaos axe.\n");
tell_room(environment(caster_ob), caster_ob->query_name()+" calls the void and receives a chaos axe.\n", ({ caster_ob }));
ob = clone_object("/guilds/warlock/obj/axe");
