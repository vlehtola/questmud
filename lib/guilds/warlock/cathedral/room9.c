...
reset(arg) {
        ...
        "The northern wall of this chamber is a iron guillotine with lots of runes carved on it and it seems to be "+
        "quite rusted to the point of no use. The southern wall is filled with grinning skulls which are probably "+
        "from the time that the guillotine was still in use. Directly at the center of this cold chamber is a chandelier "+
        "of bones and razor-sharp blades hanging from the ceiling. The chandelier has a couple of torches burning in it.\n";
        items = allocate(12);
        items[0] = "runes";
        items[1] = "The runes on the guillotine blade read 'Feed on the blood of their necks, oh mighty god of chaos'. This device was used for sacrifices long time ago,when it was still operational";
        items[2] = "mist";
