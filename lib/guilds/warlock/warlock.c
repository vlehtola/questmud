...
"which is full of blood stains.\n";
  ...
  long_desc = "THIS GUILD IS CLOSED\n";
...
/* Guild closed 12.01.04 //Celtron */
/* contact me if you want to code it */

write("THE INVITATION IS NOT ALLOWED. THE GUILD IS CLOSED.\n");
return 1;
...
i = (pexp * 100) / mexp;
//What is this thing doing in here? --Rag
//write("PROSSA ON "+i+".\n");
switch(i) {
