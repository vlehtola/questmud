...
skill_list(int guild_level) {
  ...
  skill += (["soul channeling":guild_level*2+60]);
    if (guild_level >= 1) {
	skill += (["cast aid of chaos":(int) 80]);
	skill += (["cast minor chaos":(int) 85]);
    }
    if (guild_level >= 2) {
	skill += (["cast aid of chaos":(int) 85]);
	skill += (["cast minor chaos":(int) 90]);
    }
    if (guild_level >= 3) {
	skill += (["cast aid of chaos":(int) 90]);
	skill += (["cast minor chaos":(int) 95]);
    }
    if (guild_level >= 4) {
	skill += (["cast aid of chaos":(int) 95]);
	skill += (["cast minor chaos":(int) 100]);
    }
    if (guild_level >= 5) {
	skill += (["cast aid of chaos":(int) 100]);
    }
