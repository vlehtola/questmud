...
#define SAVE_FILE "/room/houses/data/house"+HOUSE_NUMBER+"_1"
...
"Northern store room";
  long_desc =
"You are in the northern store room. There are drawers to store equipment.\n"+
call_other("/room/houses/house_descs.c","get_long", HOUSE_NUMBER);

  add_exit("south", "/room/houses/rooms/house10_floor2");
