...
reset(arg) {
  ...
  add_exit("north", "/room/houses/rooms/house9_locker1");
  add_exit("south", "/room/houses/rooms/house9_locker2");
  add_exit("down", "/room/houses/rooms/house9");
...
jump(str) {
  ...
  move_object(this_player(), "/world/city/emerald9");
  this_player()->look();
