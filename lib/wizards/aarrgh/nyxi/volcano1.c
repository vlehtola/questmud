inherit "room/room";
reset(arg)  {
            add_exit("out", "/wizards/aarrgh/nyxi/gates");
            add_exit("east", "/wizards/aarrgh/nyxi/volcano2");
            add_exit("west", "/wizards/aarrgh/nyxi/volcano3");
            add_exit("north", "/wizards/aarrgh/nyxi/pool");
