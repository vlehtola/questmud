...
if (!chat_str) {
        ...
        chat_str[1] ="Sailor whispers to you: I want yo mutiny!\n";
chat_str[2] = "Sailor says: I attached that magnet to compass on purpose.\n";
    }
    if (!a_chat_str) {
        a_chat_str = allocate(1);
a_chat_str[0] = "Sailor screams 'So you want some action, eh?\n";
    }
