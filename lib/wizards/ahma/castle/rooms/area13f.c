...
reset(arg) {
  add_exit("north", "/wizards/ahma/castle/rooms/area13c");
  add_exit("south", "/wizards/ahma/castle/rooms/area13h");
  add_exit("west", "/wizards/ahma/castle/rooms/area13e");
  add_exit("east", "/wizards/ahma/castle/rooms/area26");
