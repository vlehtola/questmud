...
reset(arg) {
  add_exit("north", "/wizards/ahma/orc/forest/for34");
  add_exit("northwest", "/wizards/ahma/orc/forest/for33");
  add_exit("northeast", "/wizards/ahma/orc/forest/for36");
  ...
  long_desc = "The flowery meadow shimmers in every colour of the whole spectrum.\n" + 
              ...
              "into a thick wall of trees in south.\n";
