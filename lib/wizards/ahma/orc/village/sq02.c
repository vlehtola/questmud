...
reset(arg) {
  ...
  add_exit("west", "/wizards/ahma/orc/village/sq01");
  add_exit("east", "/wizards/ahma/orc/village/sq03");
  ...
  if(!mob02) { move_object(mob02 = clone_object("/wizards/ahma/orc/mob/customer"), this_object()); }
