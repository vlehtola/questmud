...
reset(arg) {
  add_exit("west", "/wizards/ahma/orc/village/sub09");
  add_exit("southeast", "/wizards/ahma/orc/village/sub03");
  add_exit("ladders", "/wizards/ahma/orc/village/sub01");
  ...
  long_desc = "Some torches attached to the tunnel walls are lighting up the way. The\n" +
              ...
              "Miscellaneous trash is floating in the brownish water. The ladders leading\n" + 
              "up are located by the northern wall.\n";

  items = allocate(8);
  items[0] = "ladders";
  items[1] = "Slimy, greenish ladders lead up from the room you are standing in. The\n" + 
  ...
  items[2] = "torches";
  items[3] = "Some lit torches have been attached to the tunnel walls, which seems strange\n" + 
             ...
             "are breathing";
  items[4] = "pipes";
  items[5] = "Some stony pipes reach the tunnel through its walls. The brownish water\n" + 
             "is flowing into the tunnel from these pipes. The pipes are too small for\n" + 
             "you to fit in them";
  items[6] = "water";
  items[7] = "In the brownish water floats various items and substances. You do not even\n" + 
             "want to think about what causes water's brown colour. The water seems to\n" + 
             "run in both clockwise and counterclockwise in this part of the sewer tunnel";
