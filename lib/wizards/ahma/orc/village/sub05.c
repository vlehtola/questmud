...
reset(arg) {
  add_exit("west", "/wizards/ahma/orc/village/sub06");
  add_exit("northeast", "/wizards/ahma/orc/village/sub04");
  ...
  long_desc = "Some torches attached to the tunnel walls are lighting up the way. The\n" +
              ...
              "Miscellaneous trash is floating in the brownish water. A small crack can\n" +
              "be seen in the southern wall.\n";
  ...
  items[6] = "crack";
  items[7] = "There is a small crack in the southern wall. The crack is so dark that you\n" + 
             "cannot see what is in there. Though, from the crack can be heard coming\n" + 
             "some squeaking voices, like there would be a rats' nest";
