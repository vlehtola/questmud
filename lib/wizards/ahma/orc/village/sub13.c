...
reset(arg) {
  add_exit("northwest", "/wizards/ahma/orc/village/sub14");
  add_exit("southwest", "/wizards/ahma/orc/village/sub12");
  add_exit("stairs", "/wizards/ahma/orc/village/sub19");
  ...
  long_desc = "The air pressure can be felt in the ears when being this deep under ground-\n" + 
              ...
              "some slimy substance can be still seen on the walls. In the western wall is a\n" +
              "hole to which the water runs in.\n";
  ...
  items[4] = "hole";
  items[5] = "A gaping hole in the western wall leads the water further in the tunnel\n" + 
  ...
  items[6] = "stairs";
  items[7] = "Rusty metal stairs in the western wall lead deeper into the tunnel system";
