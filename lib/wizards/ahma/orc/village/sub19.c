...
reset(arg) {
  ...
  if(!present("figure", this_object())) move_object(clone_object("/wizards/ahma/orc/mob/memberc"), this_object());
  if(!present("figure 2", this_object())) move_object(clone_object("/wizards/ahma/orc/mob/memberb"), this_object());
  if(!present("figure 3", this_object())) move_object(clone_object("/wizards/ahma/orc/mob/memberc"), this_object());
  ...
  if(!present("tas'gand", this_object())) move_object(clone_object("/wizards/ahma/orc/mob/tasgand"), this_object());
  
  add_exit("west", "/wizards/ahma/orc/village/sub18");
  add_exit("stairs", "/wizards/ahma/orc/village/sub13");
 ...
 items[16] = "stairs";
 items[17] = "Rusty metal stairs in the eastern wall lead upper into the tunnel system";
