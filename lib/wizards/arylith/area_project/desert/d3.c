...
add_exit("south", "/wizards/arylith/area_project/desert/d2");
add_exit("east", "/wizards/arylith/area_project/desert/d6");
add_exit("southeast", "/wizards/arylith/area_project/desert/d5");
