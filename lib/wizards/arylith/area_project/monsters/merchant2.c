...
set_log();
    set_str(query_str()*2);
    set_short("Merchant, the forger of brutal items");
    set_long("He's a special merchant that can forge rubys into rings.\n");
    set_al(90);
    set_aggressive(0);
    }
    ...
    award = clone_object("/wizards/arylith/area_project/items/ring_fighter"); 
