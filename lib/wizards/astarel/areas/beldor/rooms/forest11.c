...
reset(arg) {
  ...
  set_long(getlong());
  set_items(({"path","Path is covered with thick bottomflora and its quite hard to see.\n"+
...
add_exit("north",PATH+"rooms/forest9");
add_exit("northwest",PATH+"rooms/forest8");
add_exit("south",PATH+"rooms/ford");
