...
reset(arg) {
  ...
  add_exit("north","/wizards/bulut/catacombs/cata5");
  add_exit("south","/wizards/bulut/catacombs/cata1");
  ...
  if (!present("soul")) {
     move_object(clone_object("/wizards/bulut/catacombs/undead1"), this_object());
	  }
