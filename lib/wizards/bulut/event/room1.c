...
reset(arg) {
  add_exit("north","/wizards/bulut/event/room7");
  add_exit("south","/wizards/bulut/event/room3");
  add_exit("west","/wizards/bulut/event/room9");
  add_exit("east","/wizards/bulut/event/room5");
