...
wolf = clone_object("/wizards/bulut/forest/wolf.c");
        ...
        if (!wolf2 || !living(wolf2)) {
wolf2 = clone_object("/wizards/bulut/forest/wolf.c");
        move_object(wolf2, this_object());
...
TWO_EXIT("wizards/bulut/forest/forest5","north",
"wizards/bulut/forest/forest3","south",
"In the forest",
