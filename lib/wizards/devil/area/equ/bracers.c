inherit "obj/armour";
  start() {
   ...
   set_name("bracers");
   set_alias("bracers");
   set_short("Bracers of endless death <tarnished>");
   set_long("The bracers seems very old but still in good shape. You\n"+
                  ...
                  "by a spirit named mah'lak for paying its depts to the great emperor\n"+
                  "of zombies. You can see some writing on the bracers, it reads 'covah'");
   set_stats("str", 10);
   set_stats("con", 2);
 }
