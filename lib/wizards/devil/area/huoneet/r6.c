...
reset(arg) {
  ...
  add_exit("west","/wizards/devil/area/huoneet/r7.c");
  add_exit("east","/wizards/devil/area/huoneet/r5.c");
 set_light(2);
  ...
  long_desc = "You are walking on the small sand path which is leading to the centre of the\n"+
              ...
              "can notice some movement in the shadows. There are some footsteps on the ground,\n"+
              "like someone had walked in here short time ago. Creepy screaming echoes around\n"+
              "the graveyard.\n";
}
