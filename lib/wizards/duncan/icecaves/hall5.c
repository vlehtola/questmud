...
reset(arg) {
  ...
  add_exit("north", "/wizards/duncan/icecaves/tunnel3.c");
  ...
  long_desc = "A small hall has been formed in here by the ancient lava flow. It's separated\n"+ 
              ...
              "Cold air is floating around the hall. The ground is full of different sized\n"+
              "and coloured bones. The bones belongs to the adventurers of this realm. The\n"+ 
              "adventurers got killed by the axe of the ogres and never returned from their\n"+ 
              "journeys. This isn't certainly a safe place to gather explore. The main tunnel\n"+
              "is in the north.\n";
   ...
   items[2] = "bones";
   items[3] = "Different sized and coloured bones. The bones belongs to the adventurers of this realm.";
