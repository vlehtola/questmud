...
reset(arg) {
  ...
  add_exit("north", "/wizards/duncan/icecaves/secret2.c");

  short_desc = "A collapsed ice-hall";
  long_desc = "The ice-hall is in disorder, the ceiling has collapsed as well the ground.\n"+ 
              ...
              "over the gorge, connecting the both sides of the hall. The main tunnel is at\n"+
...
cross(str) {
  if(str == "gorge") {
    ...
    move_object(this_player(),"/wizards/duncan/icecaves/hall2.c");
