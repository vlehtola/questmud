...
reset(arg) {
  ...
  add_exit("east", "/wizards/duncan/icecaves/tunnel3.c");
  add_exit("west", "/wizards/duncan/icecaves/tunnel1.c");
  add_exit("north", "/wizards/duncan/icecaves/hall2.c");
  add_exit("south", "/wizards/duncan/icecaves/hall3.c");
