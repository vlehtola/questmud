...
add_exit("north","/wizards/duncan/island/lighthouse/corridor6");
add_exit("east","/wizards/duncan/island/lighthouse/corridor3");
...
long_desc =  "A corridor is curving inside the ancient lighthouse, leading alternately\n"+
             ...
             "dust. There's a dim light coming from east, drawing shadows on the walls.\n"+
