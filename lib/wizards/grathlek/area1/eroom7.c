...
reset(arg) {
  ...
  add_exit("east","/wizards/grathlek/area1/eroom9.c");
  add_exit("north","/wizards/grathlek/area1/eroom8.c");
  add_exit("west","/wizards/grathlek/area1/eroom5.c");
  add_exit("northeast","/wizards/grathlek/area1/eroom10.c");
  add_exit("northwest","/wizards/grathlek/area1/eroom6.c");
