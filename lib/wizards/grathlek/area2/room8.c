...
reset(arg) {
  ...
  add_exit("east","/wizards/grathlek/area2/rooma.c");
  add_exit("north","/wizards/grathlek/area2/room13.c");
  add_exit("south","/wizards/grathlek/area2/rooms.c");
  add_exit("west","/wizards/grathlek/area2/room7.c");
  set_light(1); 
  ...
  long_desc = "You are standing on the main street of Tristram.\n"+
              ...
              "The weapon shop is east from here.\n"+
