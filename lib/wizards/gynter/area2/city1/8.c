...
reset(arg) {
  ...
  if(arg) return;
  /* Assigning exits */
  add_exit("east","/wizards/gynter/area2/city1/9");
  add_exit("west","/wizards/gynter/area2/city1/7");
  add_exit("south","/wizards/gynter/area2/city1/d");
  /* setting desc */
  short_desc = "Rat Alley";
  long_desc = "This is the real ghetto in Strekhard.\n"+
              "There lies garbage in the corners of the walls.\n"+
              "The dirt klings to the the walls of the houses.\n";
}
