...
reset(arg) {
  /* Assigning exits */
  add_exit("south","/wizards/gynter/area2/city1/n");
  /* setting desc */
  short_desc = "A weapons shop";
  long_desc = "A weapons shop. Not very tidy though, there are spiderwebs hanging\n"+
...
read(str) {
  ...
  write("war with Therheran. All weapons have been confiscated by the king.\n");
  return 1;
}
