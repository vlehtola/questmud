...
chat_str[3] = "Citizen says: I remember how it was before the war with Storuman... at that time we were at war with Stensele.\n";
  }
...
monster_init() {
  if(!this_player()->query_quests("gomorra")) { return 1; }
}
