...
object mob, mob1; int rn;  reset(arg) {
  ...
  if(arg) return;
  /* Assigning exits */
  add_exit("southeast","/wizards/gynter/darke/city/garden/2g16");
  add_exit("north","/wizards/gynter/darke/city/garden/2g18");
  /* setting desc */
  ...
  if (rn == 1) {
    ...
    long_desc = "This is the ultimate proof of the black souls that the\n"+
                ...
                "and rotting tulips. Some tulips are even planted with the dark\n"+
