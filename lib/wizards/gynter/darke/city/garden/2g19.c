...
object mob, mob1; int rn;  reset(arg) {
  ...
  if(arg) return;
  /* Assigning exits */
  add_exit("west","/wizards/gynter/darke/city/garden/2g18");
  add_exit("southeast","/wizards/gynter/darke/city/garden/2e");
  /* setting desc */
  short_desc = "The Tulip Garden";
  rn = random(3);
  if (rn == 1) {
    long_desc = "This is the tulip garden. This part of the garden has\n"+
                "been cared for by the lovers. They have planted\n"+
                "this garden to symbolise the break from their\n"+
                "parents, or their lack of it,.\n";
  } else if (rn == 2) {
    long_desc = "As you enter this room you intuitively notice that\n"+
                "something is wrong. The stunning beauty that is in the\n"+
                "other rooms exist here aswell, but something is amiss here.\n"+
                "After careful examination you spot some black tulips in the midst\n"+
                "of all the other beautiful red and yellow tulips. Another\n"+
