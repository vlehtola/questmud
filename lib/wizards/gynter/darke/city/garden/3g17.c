...
object mob, mob1; int rn;  reset(arg) {
  ...
  if(arg) return;
  /* Assigning exits */
  add_exit("southeast","/wizards/gynter/darke/city/garden/3g16");
  add_exit("north","/wizards/gynter/darke/city/garden/3g18");
  /* setting desc */
  short_desc = "The cactus Garden";
  rn = random(3);
  if (rn == 1) {
    long_desc = "This is the cactus garden. This part of the garden has\n"+
    ...
    long_desc = "As you enter this room you intuitively notice that\n"+
                ...
                "After careful examination you spot some black cactuss in the midst\n"+
                "of all the other beautiful red and yellow cactuss. Another\n"+
    ...
    long_desc = "This is the ultimate proof of the black souls that the\n"+
                ...
                "and rotting cactuss. Some cactuss are even planted with the dark\n"+
