...
object mob, mob1;
  ...
  if(arg) return;
  /* Assigning exits */
  add_exit("southeast","/wizards/gynter/darke/city/garden/4g16");
  add_exit("north","/wizards/gynter/darke/city/garden/4g18");
  /* setting desc */
  short_desc = "The danderline Garden";
  rn = random(3);
  if (rn == 1) {
    long_desc = "This is the danderline garden. This part of the garden has\n"+
    ...
    long_desc = "As you enter this room you intuitively notice that\n"+
                ...
                "After careful examination you spot some black danderlines in the midst\n"+
                "of all the other beautiful red and yellow danderlines. Another\n"+
    ...
    long_desc = "This is the ultimate proof of the black souls that the\n"+
                ...
                "and rotting danderlines. Some danderlines are even planted with the dark\n"+
