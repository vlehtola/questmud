...
reset(arg) {
  ...
  set_race("dark elf");
  set_alias("guard");
  set_short("A captain of the guards.");
  set_long("This is one of the Captains that control this city.\n"+
           "They do not control this city by the power of their soldiers,\n"+
           "But out of their own power.\n");
  set_al(0);
  set_aggressive(0);
