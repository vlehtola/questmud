//Fixed those wield commands -- Rag 21.4.04
inherit "obj/monster";
...
reset(arg) {
  ...
  set_race("dark elf");
  set_alias("guard");
  set_short("A lazy guard.");
  set_long("This is one of the lazy guards of the Dark elfs.\n"+
           "Do not underestimate them just because they _look_ lazy.\n");
  set_al(-300);
    set_level(random(4)+40);
        set_str(random(60)+180);
