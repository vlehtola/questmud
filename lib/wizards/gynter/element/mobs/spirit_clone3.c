...
reset(arg) {
    ...
    call_other(this_object(), "set_name", "yellow spirit");
    call_other(this_object(), "set_alias", "spirit");
    call_other(this_object(), "set_short", "A yellow spirit");
    ...
    armour = clone_object("/wizards/gynter/element/eq/spirit_leggings");
