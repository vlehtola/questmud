...
reset(arg) {
  ...
  add_exit("north","/wizards/irmeli/area2/ruum19.c");
  add_exit("south","/wizards/irmeli/area2/ruum17.c");
  set_not_out(1);
  
  short_desc = "Big kitchen";
  long_desc = "This is the kitchen where chefs prepair the food for miners. A terrible\n"+
                "smell is coming from the big pot. There is a small helpdesk for\n"+
                "the chefs next to the big pot.\n";   
  
  items = allocate(4);
  items[0] = "helpdesk";
  items[1] = "A small helpdesk is made of wood. Chefs use it for chopping food"; 
  items[2] = "pot";
