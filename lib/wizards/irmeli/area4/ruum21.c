...
reset(arg) {
  ...
  add_exit("west","/wizards/irmeli/area4/ruum22.c");
  add_exit("east","/wizards/irmeli/area4/ruum20.c");
  set_not_out(1);

  short_desc = "Floor two inside the Orthanc, tower of death";
  long_desc = "A small corridor leading you to the western-wing in floor two. This long\n"+
