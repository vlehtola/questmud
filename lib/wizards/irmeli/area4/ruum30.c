...
reset(arg) {
  ...
  add_exit("east","/wizards/irmeli/area4/ruum31.c");

  add_exit("west","/wizards/irmeli/area4/ruum27.c");
  ...
  long_desc = "A small corridor leading you to the eastern-wing in floor three. This long\n"+
