...
reset(arg) {
  ...
  add_exit("east","/wizards/irmeli/area4/ruum38.c");

  add_exit("west","/wizards/irmeli/area4/ruum34.c");
  ...
  long_desc = "A small corridor leading you to the eastern-wing in floor four. This long\n"+
