...
reset(arg) {
  ...
  add_exit("south","/wizards/irmeli/area4/ruum60.c");
  add_exit("east","/wizards/irmeli/area4/ruum56.c");
  set_not_out(1);

  short_desc = "On a balcony at the top of Orthanc, tower of death";
  long_desc = "You are standing on a balcony, which continues to the south and east. The\n"+
