...
reset(arg) {
  ...
  add_exit("east","/wizards/irmeli/area4/ruum7.c");

  add_exit("west","/wizards/irmeli/area4/ruum3.c");
  ...
  long_desc = "A small corridor leading you to the eastern-wing of this tower. You notice\n"+
