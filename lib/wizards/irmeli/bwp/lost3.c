...
reset(arg) {
  ...
  add_exit("south","/wizards/irmeli/bwp/lost4.c");



  add_exit("north","/wizards/irmeli/bwp/lost4.c");



  add_exit("east","/wizards/irmeli/bwp/lost4.c");



  add_exit("west","/wizards/irmeli/bwp/lost4.c");
