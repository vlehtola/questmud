...
reset(arg) {
  ...
  add_exit("south","/wizards/irmeli/bwp/room5.c");



  add_exit("north","/wizards/irmeli/bwp/room5.c");



  add_exit("east","/wizards/irmeli/bwp/room5.c");



  add_exit("west","/wizards/irmeli/bwp/room5.c");
