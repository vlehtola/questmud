...
reset(arg) {
  ...
  add_exit("east","/wizards/irmeli/bwp/room31.c");

  add_exit("west","/wizards/irmeli/bwp/room10.c"); 

  add_exit("north","/wizards/irmeli/bwp/room32.c");

  add_exit("south","/wizards/irmeli/bwp/room33.c"); 
