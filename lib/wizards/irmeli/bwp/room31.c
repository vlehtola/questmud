...
reset(arg) {
  ...
  add_exit("east","/wizards/irmeli/bwp/room36.c");



  add_exit("west","/wizards/irmeli/bwp/room30.c"); 



  add_exit("north","/wizards/irmeli/bwp/room34.c");



  add_exit("south","/wizards/irmeli/bwp/room35.c"); 
