...
reset(arg) {
  ...
  add_exit("north","/wizards/irmeli/bwp/room38.c");



  add_exit("east","/wizards/irmeli/bwp/room40.c");



  add_exit("west","/wizards/irmeli/bwp/room31.c"); 



  add_exit("south","/wizards/irmeli/bwp/room37.c");
