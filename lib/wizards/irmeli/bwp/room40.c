...
reset(arg) {
  ...
  add_exit("north","/wizards/irmeli/bwp/room39.c");



  add_exit("east","/wizards/irmeli/bwp/room43.c");



  add_exit("west","/wizards/irmeli/bwp/room36.c"); 



  add_exit("south","/wizards/irmeli/bwp/room41.c");
