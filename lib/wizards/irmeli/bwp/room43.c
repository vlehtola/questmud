...
reset(arg) {
  ...
  add_exit("north","/wizards/irmeli/bwp/room42.c");



  add_exit("east","/wizards/irmeli/bwp/room46.c");



  add_exit("west","/wizards/irmeli/bwp/room40.c"); 



  add_exit("south","/wizards/irmeli/bwp/room44.c");
