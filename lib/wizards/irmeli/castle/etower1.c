...
reset(arg) {
  ...
  add_exit("stairs", "/wizards/irmeli/castle/etower2.c");
  add_exit("down", "/wizards/irmeli/castle/etower.c");
 
 short_desc = "Inside of the east tower of castle Asgroth";
  long_desc = "The east tower is gloomy from inside. You are standing in the spiral stairs which\n"+
              ...
              "tower. Spider webs are hanging from the walls. It seems that the east tower\n"+
