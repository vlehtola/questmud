...
reset(arg) {
  ...
  add_exit("stairs", "/wizards/irmeli/castle/etower3.c");
  add_exit("down", "/wizards/irmeli/castle/etower1.c");
 ...
 short_desc = "Inside of the east tower of castle Asgroth";
  long_desc = "You are standing in the spiral stairs which leads up and down. The top of the\n"+
              ...
              "It seems that the east tower isn't in use anymore. There are no windows on\n"+
              "the walls.\n";
