...
reset(arg) {
  ...
  add_exit("stairs", "/wizards/irmeli/castle/eroof.c");
  add_exit("down", "/wizards/irmeli/castle/etower2.c");
 ...
 short_desc = "Inside of the east tower of castle Asgroth";
  long_desc = "You are standing in the spiral stairs which leads up. You can see the top of the tower.\n"+
              ...
              "from the inside. Spiderwebs are hanging from the walls. It seems that the east\n"+
...
write("As you pull the curtain it falls down to the ground.\n"+ 
    ...
    add_exit("balcony", "/wizards/irmeli/castle/ebalcony.c");
  return 1;
}
