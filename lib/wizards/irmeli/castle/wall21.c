...
add_exit("east","/wizards/irmeli/castle/wall1.c");
add_exit("west","/wizards/irmeli/castle/wall20.c");
...
long_desc = "On the top of the castle's disintegrating south wall. A beautiful view to the\n"+
            ...
            "roof is westwards. A strong and cold wind is blowing hard, shaking the castle's\n"+
