...
add_exit("south","/wizards/irmeli/castle/yard11.c");
add_exit("west","/wizards/irmeli/castle/yard19.c");
add_exit("east","/wizards/irmeli/castle/yard17.c");
add_exit("southwest","/wizards/irmeli/castle/yard10.c");
add_exit("southeast","/wizards/irmeli/castle/yard12.c");
...
long_desc = "The yard ends suddenly. The high castle walls are surrounding the grassy yard\n"+
            ...
            "covered with old blood. It's located towards southeast. A well can be seen\n"+
            "couple meters ahead in east. There are two big towers rising up to the sky.\n"+
            "Another is towards northwest and the other towards east.\n";
