...
add_exit("south","/wizards/irmeli/castle/yard10.c");
add_exit("east","/wizards/irmeli/castle/yard18.c");
add_exit("northwest","/wizards/irmeli/castle/yard20.c");
add_exit("southeast","/wizards/irmeli/castle/yard11.c");
...
long_desc = "You are standing next to the north wall. The high castle walls surround the\n"+
            ...
            "located towards southeast. A well is towards east. There are two big towers\n"+
            "rising up to the sky. Another is towards northwest and the other towards\n"+
            "east.\n";
