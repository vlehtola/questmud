...
reset(arg) {
if(!monster) { 
monster = clone_object("/wizards/irmeli/castle/monsters/etowerguard.c");
move_object(monster, this_object());
}
if(arg) return;
add_exit("southwest","/wizards/irmeli/castle/yard15.c");


short_desc = "In front of the east tower";
long_desc = "Standing by the east tower. The tower is so high that you can't see its top\n"+
...
set_light(4); 
   ...
   items = allocate(6);
   items[0] = "tower";
   items[1] = "The east tower is high. It's made of solid rock and there are no windows in it.";
   items[2] = "footprints";
