...
add_exit("north","/wizards/irmeli/castle/yard4.c");
add_exit("west","/wizards/irmeli/castle/yard.c");
add_exit("east","/wizards/irmeli/castle/yard7.c");
add_exit("northwest","/wizards/irmeli/castle/yard1.c");
add_exit("northeast","/wizards/irmeli/castle/yard8.c");
add_exit("stairs","/wizards/irmeli/castle/wall3.c");
