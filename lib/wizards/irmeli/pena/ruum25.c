...
reset(arg) {
  ...
  add_exit("north","/wizards/irmeli/pena/ruum30.c");
  add_exit("south","/wizards/irmeli/pena/ruum24.c");
  add_exit("west","/wizards/irmeli/pena/ruum26.c");
  add_exit("southwest","/wizards/irmeli/pena/ruum23.c");
  add_exit("northwest","/wizards/irmeli/pena/ruum29.c");
