...
reset(arg) {
  ...
  add_exit("north","/wizards/irmeli/pena/ruum28.c");
  add_exit("south","/wizards/irmeli/pena/ruum22.c");
  add_exit("east","/wizards/irmeli/pena/ruum26.c");
  add_exit("southeast","/wizards/irmeli/pena/ruum23.c");
  add_exit("northeast","/wizards/irmeli/pena/ruum29.c");
