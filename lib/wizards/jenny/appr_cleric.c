...
check_advance_rec(lev) {
  mapping sk;
  sk = ([ ]);
  sk += ([2:"cast divine:20;cast minor:20;cast transfer:20;"]);
  return sk;
}
...
skill_list(int guild_level) {
    ...
    if (guild_level >= 1) {
      skill += (["cast transfer":(int) 20]);
      skill += (["cast minor":(int) 20]);
      skill += (["cast divine":(int) 20]);
      skill += (["channel":(int) 5]);
      skill += (["cast heal":(int) 20]);
    }
    ...
    if (guild_level >= 3) {
      skill += (["cast minor":(int) 25]);
      skill += (["cast divine":(int) 25]);
    }
    if (guild_level >= 4) {
     }
    if (guild_level >= 5) {
    ...
    if (guild_level >= 8) {
      skill += (["chanting":(int) 5]);
      skill += (["cast minor":(int) 40]);
    }
    if (guild_level >= 9) {
      skill += (["channel":(int) 25]);
      skill += (["cast minor":(int) 50]);
    }
    if (guild_level >= 10) {
    ...
    if (guild_level >= 11) {
      skill += (["cast cure":(int) 5]);
      skill += (["cast minor":(int) 60]);
    }
    if (guild_level >= 12) {
      skill += (["cast heal":(int) 25]);
      skill += (["channel":(int) 30]);
      skill += (["chanting":(int) 15]);
    }
    if (guild_level >= 13) {
      skill += (["cast transfer":(int) 25]);
      skill += (["cast minor":(int) 70]);
    }
    if (guild_level >= 14) {
      skill += (["cast minor":(int) 80]);
    }
    if (guild_level >= 15) {
