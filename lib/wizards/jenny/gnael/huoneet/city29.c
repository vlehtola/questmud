...
reset(arg) {
        ...
        add_exit("west","/wizards/jenny/gnael/huoneet/city30.c");
        add_exit("east","/wizards/jenny/gnael/huoneet/city43.c");
        add_exit("south","/wizards/jenny/gnael/huoneet/city28.c");

  short_desc = "You are walking on a street";
  long_desc = "You are walking on a street, there is a small\n"+
              "crossing in here that leads into the southeast\n"+
              ...
              "house can be seen in northeast.\n";
        ...
        items[6] = "house";
        items[7] = "The mayor's house can be seen in northeast";
