...
reset(arg) {
  ...
  if(arg) return;
        ...
        add_exit("north","/wizards/jenny/gnael/huoneet/gate2.c");
        add_exit("south","/wizards/jenny/gnael/huoneet/city41.c");
  ...
  long_desc = "You are walking on the main street of the city of\n"+
              ...
              "some smaller buildings. There are also some shops\n"+
              "in the west part of the city. In east you can see the roof\n"+
              "of the mayor's house behind some smaller buildings.\n"+
              "You can see a massive gate leading outside the city\n"+
              "in north. Many people are coming and going from everywhere all\n"+
        ...
        items[8] = "gate";
        items[9] = "The northern gate leading outside the city";
