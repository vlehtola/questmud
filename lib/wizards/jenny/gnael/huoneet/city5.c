...
reset(arg) {
        ...
        add_exit("west","/wizards/jenny/gnael/huoneet/city6.c");
        add_exit("north","/wizards/jenny/gnael/huoneet/city4.c");
        add_exit("south","/wizards/jenny/gnael/huoneet/city7.c");

  short_desc = "You are walking on a street";
  long_desc = "You are walking on a street near the mansion. There\n"+
              "is a crossing ahead of you that leads to several\n"+
