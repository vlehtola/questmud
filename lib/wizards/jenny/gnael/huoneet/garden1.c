...
reset(arg) { 
        ...
        add_exit("south","/wizards/jenny/gnael/huoneet/garden2.c");
        add_exit("mansion","/wizards/jenny/gnael/huoneet/mansion3.c");
  ...
  long_desc = "You have arrived into a beautiful garden. Everywhere\n"+
              ...
              "you can see the city around the garden. A small wooden\n"+
              "door is leading into the mansion near you.\n";
