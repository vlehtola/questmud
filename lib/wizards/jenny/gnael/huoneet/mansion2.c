...
reset(arg) { 
        ...
        add_exit("north","/wizards/jenny/gnael/huoneet/mansion3.c");
        add_exit("northeast","/wizards/jenny/gnael/huoneet/mansion4.c");
        add_exit("east","/wizards/jenny/gnael/huoneet/mansion1.c");
  ...
  long_desc = "You are inside a huge mansion, everywhere you look\n"+
              ...
              "leading to a staircase in northeast which seems to be leading\n"+
              "into the second floor of the mansion. In north you can\n"+
