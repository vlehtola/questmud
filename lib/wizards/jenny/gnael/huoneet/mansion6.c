...
reset(arg) { 
        ...
        add_exit("west","/wizards/jenny/gnael/huoneet/mansion1.c");
        add_exit("northwest","/wizards/jenny/gnael/huoneet/mansion4.c");
        add_exit("north","/wizards/jenny/gnael/huoneet/mansion5.c");
