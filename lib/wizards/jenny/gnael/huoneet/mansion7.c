...
reset(arg) { 
        ...
        add_exit("west","/wizards/jenny/gnael/huoneet/mansion11.c");
        add_exit("east","/wizards/jenny/gnael/huoneet/mansion8.c");
        add_exit("down","/wizards/jenny/gnael/huoneet/mansion4.c");
