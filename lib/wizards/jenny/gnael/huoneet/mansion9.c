...
reset(arg) { 
        ...
        add_exit("west","/wizards/jenny/gnael/huoneet/mansion8.c");
        add_exit("north","/wizards/jenny/gnael/huoneet/mansion10.c");
  ...
  long_desc = "The second floor of the mansion looks bit different,\n"+
              ...
              "person is crying for. In north you can see a small\n"+
              "room.\n";
