...
reset(arg) {
        ...
        add_exit("west","/wizards/jenny/gnael/huoneet/mayor2.c");
        add_exit("northwest","/wizards/jenny/gnael/huoneet/mayor4.c");
        add_exit("north","/wizards/jenny/gnael/huoneet/mayor5.c");
        add_exit("northeast","/wizards/jenny/gnael/huoneet/mayor6.c");
        add_exit("east","/wizards/jenny/gnael/huoneet/mayor3.c");
        add_exit("out","/wizards/jenny/gnael/huoneet/city55.c");
