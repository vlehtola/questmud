...
reset(arg) {
        ...
        add_exit("north","/wizards/jenny/gnael/huoneet/mayor10.c");
        add_exit("east","/wizards/jenny/gnael/huoneet/mayor12.c");
        add_exit("south","/wizards/jenny/gnael/huoneet/mayor13.c");
