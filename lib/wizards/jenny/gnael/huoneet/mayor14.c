...
reset(arg) {
        ...
        add_exit("north","/wizards/jenny/gnael/huoneet/mayor13.c");
        add_exit("east","/wizards/jenny/gnael/huoneet/mayor15.c");
        add_exit("south","/wizards/jenny/gnael/huoneet/mayor16.c");
