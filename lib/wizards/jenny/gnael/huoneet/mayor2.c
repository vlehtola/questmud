...
reset(arg) {
        ...
        add_exit("north","/wizards/jenny/gnael/huoneet/mayor4.c");
        add_exit("northeast","/wizards/jenny/gnael/huoneet/mayor5.c");
        add_exit("east","/wizards/jenny/gnael/huoneet/mayor1.c");
        add_exit("out","/wizards/jenny/gnael/huoneet/city57.c");
