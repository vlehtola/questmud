...
reset(arg) {
  ...
  if(arg) return;
        ...
        add_exit("west","/wizards/jenny/gnael/huoneet/mayor5.c");
        add_exit("northwest","/wizards/jenny/gnael/huoneet/mayor8.c");
        add_exit("north","/wizards/jenny/gnael/huoneet/mayor7.c");
        add_exit("south","/wizards/jenny/gnael/huoneet/mayor3.c");
        add_exit("southwest","/wizards/jenny/gnael/huoneet/mayor1.c");
