...
reset(arg) {
  ...
  if(arg) return;
        ...
        add_exit("west","/wizards/jenny/gnael/huoneet/mayor8.c");
        add_exit("south","/wizards/jenny/gnael/huoneet/mayor6.c");
        add_exit("southwest","/wizards/jenny/gnael/huoneet/mayor5.c");
