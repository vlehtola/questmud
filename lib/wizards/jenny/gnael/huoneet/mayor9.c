...
reset(arg) {
  ...
  if(arg) return;
        ...
        add_exit("east","/wizards/jenny/gnael/huoneet/mayor8.c");
        add_exit("southeast","/wizards/jenny/gnael/huoneet/mayor5.c");
        add_exit("south","/wizards/jenny/gnael/huoneet/mayor4.c");
