...
reset(arg) { 
        ...
        add_exit("west","/wizards/jenny/gnael/huoneet/thief3.c");
        add_exit("northwest","/wizards/jenny/gnael/huoneet/thief4.c");
        add_exit("north","/wizards/jenny/gnael/huoneet/thief1.c");
  ...
  long_desc = "You are inside a dark room. Everywhere you look\n"+
              ...
              "A staircase leading downstairs is located in west\n";
