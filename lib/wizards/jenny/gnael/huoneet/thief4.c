...
reset(arg) { 
        ...
        add_exit("east","/wizards/jenny/gnael/huoneet/thief1.c");
        add_exit("southeast","/wizards/jenny/gnael/huoneet/thief2.c");
        add_exit("south","/wizards/jenny/gnael/huoneet/thief3.c");
  ...
  long_desc = "You are inside a dark room. Everywhere you look\n"+
              ...
              "A staircase leading downstairs is located in south\n";
