...
if(arg) return;
        if (!monster) {
                monster = clone_object("/wizards/jenny/gnael/mosut/neramaia.c");
                move_object(monster, this_object());
        }


        add_exit("north","/wizards/jenny/gnael/huoneet/well9.c");
        add_exit("south","/wizards/jenny/gnael/huoneet/well11.c");
