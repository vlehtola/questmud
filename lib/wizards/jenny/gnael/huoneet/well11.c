...
if(arg) return;
        if (!monster) {
                monster = clone_object("/wizards/jenny/gnael/mosut/bilidrim.c");
                move_object(monster, this_object());
        }


        add_exit("north","/wizards/jenny/gnael/huoneet/well10.c");
        add_exit("south","/wizards/jenny/gnael/huoneet/well12.c");
