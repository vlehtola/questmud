...
reset(arg) {
        ...
        add_exit("south","/wizards/jenny/gnael/huoneet/well9.c");
    ...
    long_desc = "You are walking in a gloomy looking dungeon\n"+
        ...
        set_door_dir("north", "/wizards/jenny/gnael/huoneet/well7.c",1);
        set_door_link("/wizards/jenny/gnael/huoneet/well7.c",1);
        set_door_code("803",1);
        set_locked(1,1);
