...
reset(status arg) {
  ...
  if(t==0) {
    move_object(clone_object("/wizards/jenny/hriak/maze/eq/robes02"), this_object());
    init_command("wear robes");

    move_object(clone_object("/wizards/jenny/hriak/maze/eq/ring02"), this_object());
    init_command("wear ring");

  }
  
  if(t==1) {
    move_object(clone_object("/wizards/jenny/hriak/maze/eq/cloak02"), this_object());
    init_command("wear cloak");

    move_object(clone_object("/wizards/jenny/hriak/maze/eq/amulet02"), this_object());
    init_command("wear amulet");

  }
  
  if(t==2) {
    move_object(clone_object("/wizards/jenny/hriak/maze/eq/boots02"), this_object());
    init_command("wear boots");

    move_object(clone_object("/wizards/jenny/hriak/maze/eq/crown02"), this_object());
