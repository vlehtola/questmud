...
TWO_EXIT("/wizards/jenny/linnake/huoneet/netower2.c", "up",
           "/wizards/jenny/linnake/huoneet/ylakerta68.c", "south",
           ...
           "to keep this place clean. There are stairs leading to a tower\n" +
           "next to you and you see some light coming from there. Everything\n" +
