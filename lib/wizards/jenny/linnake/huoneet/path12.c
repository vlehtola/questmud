...
TWO_EXIT("/wizards/jenny/linnake/huoneet/path13.c", "north",
           "/wizards/jenny/linnake/huoneet/path11.c", "east",
           "You are walking in narrow hallway",
           "You are walking in narrow hallway that leads to north and east.\n" +
