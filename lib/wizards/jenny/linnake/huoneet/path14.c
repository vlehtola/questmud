...
TWO_EXIT("/wizards/jenny/linnake/huoneet/path13.c", "south",
           "/wizards/jenny/linnake/huoneet/path15.c", "east",
           "You are walking in narrow hallway",
           "You are walking in narrow hallway that leads to east and south.\n" +
           ...
           "You can see dead end at east and a strange looking man who is scratching\n" +
           "the wall with hes hands.\n", 1)
