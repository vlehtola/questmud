...
TWO_EXIT("/wizards/jenny/linnake/huoneet/path22.c", "east",
           "/wizards/jenny/linnake/huoneet/entrance.c", "west",
           "You are walking in narrow hallway",
           "You are walking in narrow hallway that leads to west and east.\n" +
