...
reset(arg) {
        ...
        add_exit("west","/wizards/jenny/linnake/huoneet/prison17.c");         
        add_exit("south","/wizards/jenny/linnake/huoneet/prison15.c");
        add_exit("southwest","/wizards/jenny/linnake/huoneet/prison14.c");
        ...
        set_door_dir("east", "/wizards/jenny/linnake/huoneet/jail6.c",1);
        set_door_link("/wizards/jenny/linnake/huoneet/jail6.c",1);
        set_door_code("571", 1);
        set_locked(1, 1);
