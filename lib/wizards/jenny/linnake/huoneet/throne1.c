...
reset(arg) {
    ...
    if(!present("guard")) {
      move_object(clone_object("/wizards/jenny/linnake/mosut/bodyguard.c"), this_object());
        ...
        add_exit("north","/wizards/jenny/linnake/huoneet/throne6.c");
        add_exit("northeast","/wizards/jenny/linnake/huoneet/throne5.c");
        add_exit("east","/wizards/jenny/linnake/huoneet/throne2.c");
