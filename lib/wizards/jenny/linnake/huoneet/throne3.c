...
reset(arg) {
    ...
    if(!present("guard")) {
      move_object(clone_object("/wizards/jenny/linnake/mosut/bodyguard.c"), this_object());
        ...
        add_exit("west","/wizards/jenny/linnake/huoneet/throne2.c");
        add_exit("northwest","/wizards/jenny/linnake/huoneet/throne5.c");
        add_exit("north","/wizards/jenny/linnake/huoneet/throne4.c");
