...
reset(arg) {
        ...
        add_exit("north","/wizards/jenny/mehta/huoneet/forest10.c");
        add_exit("southeast","/wizards/jenny/mehta/huoneet/forest12.c");
        add_exit("southwest","/wizards/jenny/mehta/huoneet/forest14.c");
