...
reset(arg) {
        ...
        add_exit("northeast","/wizards/jenny/mehta/huoneet/forest11.c");
        add_exit("south","/wizards/jenny/mehta/huoneet/forest15.c");
        add_exit("southwest","/wizards/jenny/mehta/huoneet/forest16.c");
