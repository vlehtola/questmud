...
reset(arg) {
        ...
        add_exit("west","/wizards/jenny/mehta/huoneet/forest5.c");
        add_exit("northwest","/wizards/jenny/mehta/huoneet/forest2.c");
        add_exit("northeast","/wizards/jenny/mehta/huoneet/forest7.c");
        add_exit("southeast","/wizards/jenny/mehta/huoneet/forest9.c");
