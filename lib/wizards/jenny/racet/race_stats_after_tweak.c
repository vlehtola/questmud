...
reset(arg) {
  ...
  races += ([ "balrog":     ({"spec", "med", "110", "60", "110", "30", "60", "enormous",      "low", "med","130", "high","tremendous blow", }) ]);
  races += ([ "dragon":     ({"high",  "spec","60", "60", "75", "110", "110", "enormous",    "med", "spec","130", "high","cast information",}) ]);
/*
  races += ([ "": ({"", "", "", "", "", "", "", "", "", "", "", "", "", }) ]);
*/
/* put your tune here. */
