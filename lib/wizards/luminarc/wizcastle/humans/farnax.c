...
//Added check for illusions --Rag
    if (present("anti-illusion-stone", this_object()) && this_player()->query_name()==tmp1) 
           { 
...
int go_away() {
tell_room(environment(this_object()),"Farnax seems satisfied, and leaves.\n");
