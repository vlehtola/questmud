...
case "dragon blow": return 2;
case "claws storm": return 5;
case "sky strike": return 8;
...
case "mastery of sky strike": return 8;
case "whirlwind": return 6;
case "focused sky strike": return 8;
case "focused shadow blow": return 5;
case "body anatomy": return 8;
