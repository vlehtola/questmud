...
reset(arg) {
  ...
  set_long("The Psionicists guild is the place where all people\n"+
           "who start to develop and improve their mind powers come. The guild\n"+
           "room itself is simple and quiet place. A couple of chandliers full of\n"+
           "candles is burning both side of the guild room.\n");
  set_not_out();
  set_light(3);
