...
extra_reset() {
    ...
    if (!monster) {
        monster = clone_object("/wizards/nalle/area/monsters/henry");
...
"The ambience is very calm and no sounds of\n" +
"battle or training can be heard. There is a\n" +
"large fountain in here, but it is out of water.\n", 3)
