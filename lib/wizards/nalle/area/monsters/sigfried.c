...
reset(arg) {
    ...
    set_long("Sigfried was once turned into undead for an act known only by few.\n");
    set_al(-15);
    set_log();
    set_aggressive(0);
    ...
    set_move_at_random(0);
        ...
        chat_str[2] =
          "Sigfried curses the magical chains which link him to the wall.\n";
    }
    if (!a_chat_str) {
   ...
   weapon = clone_object("/wizards/nalle/area/eq/sigsword");
