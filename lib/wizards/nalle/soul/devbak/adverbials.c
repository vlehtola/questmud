...
own_ob=" "+this_player()->query_possessive()+" "; 
own_obs="your own ";
                                  }
else { own_ob=""; own_obs=""; }
...
write("You "+e_map[verb,0]+prep+own_obs+target+".\n");
if(!pseudo_target)
tell_object(target_ob, TPNAME +" "+e_map[verb,1]+prep+"you.\n");
       }
say(TPNAME +" "+e_map[verb,1]+prep+own_ob+target+".\n",target_ob); 
return 1;
                                    }
...
write("You "+e_map[verb,0]+prep+own_obs+target+" "+adverb+".\n");
if(!pseudo_target)
tell_object(target_ob, TPNAME +" "+e_map[verb,1]+prep+"you "+adverb+".\n");
       }
say(TPNAME +" "+e_map[verb,1]+prep+own_ob+target+" "+adverb+".\n",target_ob); 
return 1;
                                    }
...
write("You "+e_map[verb,0]+prep+own_obs+target+bprep+" "+bodypart+".\n");
if(!pseudo_target) {
...
say(TPNAME +" "+e_map[verb,1]+prep+own_ob+target+bprep+bodypart+".\n",target_ob); 
return 1;
                                    }
...
write("You "+e_map[verb,0]+prep+own_obs+target+bprep+" "+bodypart+" "+adverb+".\n");
if(!pseudo_target)
if(!e_map[verb,6]) bprep="r "; else bprep=" "+e_map[verb,6]+" ";
...
say(TPNAME +" "+e_map[verb,1]+prep+own_ob+target+bprep+bodypart+" "+adverb+".\n",target_ob); 
return 1;
                                    }
return 1;
}
