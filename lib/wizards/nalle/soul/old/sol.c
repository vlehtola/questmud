...
get_adverb(str) {
    ...
    if (str == "impotently") { return str; }
    if (str == "inanely") { return str; }
    if (str == "intensly") { return str; }
    if (str == "laggedly") { return str; }
    if (str == "longingly") { return str; }
...
boo(str) {
    ...
    if (ghost())
        return 0;
    if (!str) {
        write("You boo loudly.\n");
        say(cap_name + " boos loudly.\n");
        return 1;
    }
    who = present(lower_case(str), environment(this_player()));
    if (!who || !living(who) || who == this_player())
        return 0;
    tell_object(who, cap_name + " boos at you insolently.\n");
...
drool(str) {
    ...
    if (ghost())
        return 0;
    if (!str) {
        write("You drool all over the place.\n");
        say(cap_name + " drools all over the place.\n");
        return 1;
    }
    who = present(lower_case(str), environment(this_player()));
    if (!who || !living(who) || who == this_player())
...
eep(string str) {
    ...
    if (!str) {
        ...
        say(cap_name+" eeps fearfully.\n");
        return 1;
    }
    wh = present(str, environment(this_player()));
    if (!wh || !living(wh) || wh == this_player())
        return 0;
    tell_object(wh, cap_name + " eeps at you fearfully.\n");
    say(cap_name + " eeps at " + capitalize(str) + " fearfully.\n", wh);
...
hmpf(string str) {
    ...
    if (!wh || !living(wh) || wh == this_player())
        return 0;
    tell_object(wh, cap_name + " goes 'Hmpf' at you.\n");
    say(cap_name + " goes 'Hmpf' at " + capitalize(str) + ".\n", wh);
    write("You go 'Hmpf' at " + capitalize(str) + ".\n");
    return 1;
}
...
nibble(str) {
    ...
    say(cap_name + " nibbles on " + capitalize(str) + "s ear.\n", who);
...
ooo(string str) {
    ...
    if (!wh || !living(wh) || wh == this_player())
        return 0;
    tell_object(wh, cap_name + " goes 'Ooo' at you in wonder.\n");
    say(cap_name + " goes 'Ooo' at " + capitalize(str) + " in wonder.\n", wh);
    write("You go 'Ooo' at " + capitalize(str) + " in wonder.\n");
    return 1;
}
...
slap(str) {
    ...
    say(cap_name + " slaps " + capitalize(str) + ".\n", who);
...
wave(str) {
    ...
    if(!str) {
        write("You wave " + adverb + ".\n");
        say(cap_name + " waves " + adverb + ".\n");
        return 1;
    }
    who = present(lower_case(str), environment(this_player()));
    if (!who || !living(who) || who == this_player())
...
wink(str) {
    ...
    say(cap_name + " winks suggestively at " + capitalize(str) + ".\n", who);
    return 1;
}
...
worship(str) {
    ...
    if (ghost())
        return 0;
    if(!str) {
        write("You execute a brief ceremony in respect for the gods.\n");
        say(cap_name + " executes a ceremony in respect for the gods and immortals.\n");
        return 1;
    }
    who = present(lower_case(str), environment(this_player()));
    if (!who || !living(who) || who == this_player())
