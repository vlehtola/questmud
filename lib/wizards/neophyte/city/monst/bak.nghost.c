...
if (arg) { return;
    ...
    set_long("The ghost don't look like a normal ghost, more like"+
             "lots of ghost are binded together. It has everglowing\n"+
             "bright eye sockets.\n");
...
hit_with_spell(int damage, arg2,arg3,arg4,arg5,arg6) {
	object ob;
	ob = present("ghost", environment(this_object()));
	if(ob) {
		tell_room(environment(this_object()), "But smaller ghost steps front of the enormous ghost and spell hits smaller one.\n");
		ob->hit_with_spell(damage, arg2,arg3,arg4,arg5,arg6);
		return 1;
	}
}
