...
reset(arg) {
    ...
    set_short("Conjured ice elemental protecting the mage.");
...
special_move() {
  ...
  ob = this_object()->query_attack();
   tell_object(ob, "The elemental throws a sharp icicle at you!\n");
   say("The elemental throws a sharp icicle at "+ob->query_name()+"!\n", ob);
   ob->hit_with_spell(150, "ice");
}
