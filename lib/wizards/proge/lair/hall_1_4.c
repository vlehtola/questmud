...
reset(arg) {
  ...
  if(arg) return;
  set_not_out();
  add_exit("west","/wizards/proge/lair/hall_1_3");
  add_exit("south","/wizards/proge/lair/hall_2_4");
  add_exit("southwest", "/wizards/proge/lair/hall_2_3");
  add_exit("east", "/wizards/proge/lair/hall_1_5");
  add_exit("southeast", "/wizards/proge/lair/hall_2_5");
