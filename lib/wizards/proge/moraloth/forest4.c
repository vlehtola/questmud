...
reset(arg) {
  ...
  add_exit("west", "/wizards/proge/moraloth/forest3");
  add_exit("north","/wizards/proge/moraloth/forest5");
  add_exit("east","/wizards/proge/moraloth/forest9");
  add_exit("south","/wizards/proge/moraloth/forest8");
