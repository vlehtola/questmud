...
reset(arg) {
        ...
        add_exit("northwest","/wizards/rag/elf/e_a2");
        add_exit("west","/wizards/rag/elf/e_b3");
        add_exit("east","/wizards/rag/elf/e_b5");
        add_exit("southwest","/wizards/rag/elf/e_c3");
        add_exit("south","/wizards/rag/elf/e_c4");
        add_exit("southeast","/wizards/rag/elf/e_c5");
