...
reset(arg) {
        ...
        add_exit("northwest","/wizards/rag/elf/e_b2");
        add_exit("north","/wizards/rag/elf/e_b3");
        add_exit("northeast","/wizards/rag/elf/e_b4");
        add_exit("west","/wizards/rag/elf/e_c2");
        add_exit("east","/wizards/rag/elf/e_c4");
        add_exit("southwest","/wizards/rag/elf/e_d2");
        add_exit("south","/wizards/rag/elf/e_d3");
        add_exit("southeast","/wizards/rag/elf/e_d4");
