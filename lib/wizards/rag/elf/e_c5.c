...
reset(arg) {
        ...
        add_exit("northwest","/wizards/rag/elf/e_b4");
        add_exit("north","/wizards/rag/elf/e_b5");
        add_exit("west","/wizards/rag/elf/e_c4");
        add_exit("east","/wizards/rag/elf/e_c6");
        add_exit("southwest","/wizards/rag/elf/e_d4");
        add_exit("south","/wizards/rag/elf/e_d5");
        add_exit("southeast","/wizards/rag/elf/e_d6");
