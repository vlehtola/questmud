...
reset(arg) {
        ...
        add_exit("northwest","/wizards/rag/elf/e_c1");
        add_exit("north","/wizards/rag/elf/e_c2");
        add_exit("northeast","/wizards/rag/elf/e_c3");
        add_exit("west","/wizards/rag/elf/e_d1");
        add_exit("east","/wizards/rag/elf/e_d3");
        add_exit("southwest","/wizards/rag/elf/e_e2");
        add_exit("south","/wizards/rag/elf/e_e3");
        add_exit("southeast","/wizards/rag/elf/e_e4");
