...
reset(arg) {
        ...
        add_exit("north","/wizards/rag/elf/e_d1");
        add_exit("northeast","/wizards/rag/elf/e_d2");
        add_exit("west","/wizards/rag/elf/e_e1");
        add_exit("east","/wizards/rag/elf/e_e3");
        add_exit("southwest","/wizards/rag/elf/e_f1");
        add_exit("south","/wizards/rag/elf/e_f2");
        add_exit("southeast","/wizards/rag/elf/e_f3");
