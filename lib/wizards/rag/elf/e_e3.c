...
reset(arg) {
        ...
        case 4..5: str = "/wizards/rag/elf/monsters/snake"; break;
        case 6..8: str = "/wizards/rag/elf/monsters/fox"; break;
        ...
        add_exit("northwest","/wizards/rag/elf/e_d1");
        add_exit("north","/wizards/rag/elf/e_d2");
        add_exit("northeast","/wizards/rag/elf/e_d3");
        add_exit("west","/wizards/rag/elf/e_e2");
        add_exit("east","/wizards/rag/elf/e_e4");
        add_exit("southwest","/wizards/rag/elf/e_f2");
        add_exit("south","/wizards/rag/elf/e_f3");
        add_exit("southeast","/wizards/rag/elf/e_f4");
        ...
        set_sound(25+random(25),"You hear some noices from the trees.\n");
}
