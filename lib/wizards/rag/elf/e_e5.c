...
reset(arg) {
        ...
        add_exit("northwest","/wizards/rag/elf/e_d3");
        add_exit("north","/wizards/rag/elf/e_d5");
        add_exit("northeast","/wizards/rag/elf/e_d6");
        add_exit("west","/wizards/rag/elf/e_e4");
        add_exit("east","/wizards/rag/elf/e_e6");
        add_exit("southwest","/wizards/rag/elf/e_f4");
        add_exit("south","/wizards/rag/elf/e_f5");
        add_exit("southeast","/wizards/rag/elf/e_f6");
        ...
        long_desc = "The forest seems to get a bit darker. The birds have stopped\n"+
                        ...
                        "or other living beings. There is a shimmering pond to the east.\n";
