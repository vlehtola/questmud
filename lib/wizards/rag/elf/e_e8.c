...
reset(arg) {
        ...
        case 2: str = "/wizards/rag/elf/monsters/fox"; break;
        case 3..5: str = "/wizards/rag/elf/monsters/deer"; break;
        case 6..10: str = "/wizards/rag/elf/monsters/wolf"; break;
        ...
        add_exit("northwest","/wizards/rag/elf/e_d6");
        add_exit("west","/wizards/rag/elf/e_e7");
        add_exit("southwest","/wizards/rag/elf/e_f7");
