...
reset(arg) {
        ...
        add_exit("northwest","/wizards/rag/elf/e_e3");
        add_exit("north","/wizards/rag/elf/e_e4");
        add_exit("northeast","/wizards/rag/elf/e_e5");
        add_exit("west","/wizards/rag/elf/e_f3");
        add_exit("east","/wizards/rag/elf/e_f5");
        add_exit("southwest","/wizards/rag/elf/e_g4");
        add_exit("south","/wizards/rag/elf/e_g5");
