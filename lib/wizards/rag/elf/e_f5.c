...
reset(arg) {
        ...
        add_exit("northwest","/wizards/rag/elf/e_e4");
        add_exit("north","/wizards/rag/elf/e_e5");
        add_exit("northeast","/wizards/rag/elf/e_e6");
        add_exit("west","/wizards/rag/elf/e_f4");
        add_exit("east","/wizards/rag/elf/e_f6");
        add_exit("southwest","/wizards/rag/elf/e_g5");
        ...
        long_desc = "This forest looks very peaceful. There are beautiful trees\n"+
                        ...
                        "seems perfectly calm. There is a shimmering pond to the northeast.\n";
