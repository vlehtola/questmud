...
reset(arg) {
        ...
        add_exit("west","/wizards/rag/elf/e_g2");
        add_exit("northwest","/wizards/rag/elf/e_f1");
        add_exit("north","/wizards/rag/elf/e_f2");
        add_exit("northeast","/wizards/rag/elf/e_f3");
        add_exit("east","/wizards/rag/elf/e_g4");
        add_exit("southeast","/wizards/rag/elf/e_h1");
