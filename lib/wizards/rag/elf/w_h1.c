...
reset(arg) {
        ...
        add_exit("northeast","/wizards/rag/elf/w_g1");
        ...
        long_desc = "Tunnel leads back to northeast. Grunts and shouts can be heard\n"+
                        ...
                        "some barrels in the corner.\n";

        items = allocate(2);
        items[0] = "barrels";
        items[1] = "The barrels are full of ale, but you get the feeling that you\n"+
...
search_finished(str) {
        if(!i && str == "barrels") {
                write("You move some barrels and find some coins.\n");
