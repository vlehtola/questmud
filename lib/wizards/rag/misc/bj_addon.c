...
// Returns a full-length string of individual BJ cards
// Accepts input in form 'c4' (4 of Clubs) etc.
// If colour is set to non-zero, an ansi-coloured string
// is returned.
