...
reset(arg) {
        ...
        if(arg) return;
        add_exit("north","/wizards/rag/ruins/dark5");
        add_exit("west","/wizards/rag/ruins/dark5");
        add_exit("east","/wizards/rag/ruins/dark5");
        add_exit("south","/wizards/rag/ruins/dark5");
