...
reset(arg) {
 ...
 long_desc = "The dark dweller city lies deep inside the mountain.\n"+
  "The houses have been build inside rocks. The streets\n"+
  ...
  "top of a metallic pole.\n";
	...
	add_exit("north", "/wizards/rimber/cave/room19.c");
	add_exit("south", "/wizards/rimber/cave/room24.c");
	add_exit("east", "/wizards/rimber/cave/room23.c");
 set_not_out(1);
}
