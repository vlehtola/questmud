...
reset(arg) {
  ...
  "Stone stairs lead down below the floor.\n";
	add_exit("south", "/wizards/rimber/cave/"+c);
	add_exit("north", "/wizards/rimber/cave/"+b);
	add_exit("west", "/wizards/rimber/cave/"+a);
	add_exit("east", "/wizards/rimber/cave/"+d);
       add_exit("down", "/wizards/rimber/cave/room49.c");
 set_not_out(1);
}
