...
TWO_EXIT("players/shadow/virenda/road1", "west",
	 "players/shadow/virenda/road22", "east",
	 "Training room",
...
{
    if (!male_title_str){
	male_title_str = allocate(24);
	
	male_title_str[23]      ="reincarnation of Merlin";
	male_title_str[22]      ="the grand master sorcerer";
	male_title_str[21]      ="the master sorcerer";
	male_title_str[20]      ="the apprentice sorcerer";
	male_title_str[19]      ="reincarnation of Merlin";
	...
	fem_title_str = allocate(24);

	fem_title_str[23]       ="reincarnation of Merlin";
	fem_title_str[22]       ="the grand master sorceress";
	fem_title_str[21]       ="the master sorceress";
	fem_title_str[20]       ="the apprentice sorceress";
	fem_title_str[19]       ="reincarnation of Merlin";
	...
	neut_title_str = allocate(24);

	neut_title_str[23]      ="reincarnation of Merlin";
	neut_title_str[22]      ="the ferocious tyrannosaur";
	neut_title_str[21]      ="the small tyrannosaur";
	neut_title_str[20]      ="the vicious dragon";
	neut_title_str[19]      ="reincarnation of Merlin";
...
advance(arg)
{
    ...
    if (next_level == 20) {
	write("A new Merlin has been born.\n");
	shout("A new Merlin has been born.\n");
	return 1;
    }
    return 1;
}
...
south() {
    ...
    call_other(this_player(), "move_player", "south#room/adv_inr");
    return 1;
}
