...
TWO_EXIT("players/shadow/virenda/road1","east",
         "players/shadow/virenda/road26","north",
"Main-road Inn",
"You are in the Main-road Inn. Here you can buy food to still your\n"+
...
show_menu() {
 ...
 if(!(cm||mm||rmm)) 
  ...
  write("4: First Class beer    ");write(" ");write("     2 gp\n");
  write("\n");
