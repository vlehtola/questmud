...
THREE_EXIT("players/shadow/virenda/road2", "east",
	"players/shadow/virenda/road18", "west",
	"players/shadow/virenda/storage", "north",
"The shop",
"You are in the general shop of Virenda. You can buy or sell things here.\n" +
