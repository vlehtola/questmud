...
show_menu() {
 ...
 if(!(ss||dod||aa||gc)) 
  ...
  write("1: Shadow's Shake      ");write(ss);write(" at 0 gp\n");
  write("2: Drink o Death       ");write(dod);write(" at 0 gp\n");
  write("3: Arches acid         ");write(aa);write(" at 0 gp\n");
  write("4: Gods creation       ");write(gc);write(" at 0 gp\n");
  write("\n");
