...
reset(arg) {
	mobsters = ({ "/wizards/siki/forest/monsters/bear","/wizards/siki/forest/monsters/deer","/wizards/siki/forest/monsters/rabbit","/wizards/siki/forest/monsters/wolf",});
        ...
        if(arg) return;
        add_exit("north","room11");
        add_exit("south","room13");
        short_desc = "A twisted path";
  long_desc = "The path looks twisted and it is full of rotting things. Both side of this path\n"+
              ...
              "to be coming quite near southeast from here.\n";
}
