...
reset(arg) {
      ...
      if(!monster3) {
      monster3 = clone_object("/wizards/siki/island/monsters/smallguard");
      move_object(monster3, this_object());
      }
      if(!monster4) {
      monster4 = clone_object("/wizards/siki/island/monsters/guard3");
  ...
  add_exit("west","/wizards/siki/island/floorb1");
  add_exit("east","/wizards/siki/island/floorb7");
