inherit "room/room";
  ...
  add_exit("north","/wizards/siki/troll/f04");
  add_exit("east","/wizards/siki/troll/f06");
  add_exit("south","/wizards/siki/troll/entrance");
  add_exit("west","wizards/siki/troll/f02");
