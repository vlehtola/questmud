...
object monster,monster2;
   ...
   reset(arg) {
      if(!monster) {
      monster = clone_object("/wizards/siki/troll/monsters/huntroll");
      move_object(monster, this_object());
      }
      if(!monster2) {
      monster2 = clone_object("/wizards/siki/troll/monsters/wolf");
  ...
  add_exit("north","/wizards/siki/troll/f13");
  add_exit("east","/wizards/siki/troll/f08");
  add_exit("south","/wizards/siki/troll/f09"); 
  add_exit("west","wizards/siki/troll/f11");
