...
add_exit("north","/wizards/terror/goblin/roomit/g12.c");
add_exit("west","/wizards/terror/goblin/roomit/g14.c");
add_exit("southeast","/wizards/terror/goblin/roomit/g15.c");
