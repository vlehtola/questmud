...
if (!monster) {
 ...
 if(arg) return;
set_not_out(3);
add_exit("north","/wizards/tiergon/dungeon/b6");
add_exit("east","/wizards/tiergon/dungeon/b11");
  short_desc = "The southern aisle";
  long_desc = "The southern aisle is quite similar to the main one, for"+ 
              " the exception of the pews covering the south wall.\n";
items = allocate(2);
items[0] = "pews";
