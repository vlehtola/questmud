...
reset(arg) {
  add_exit("north","/wizards/trooper/areas/rohelm/r26.c");
  add_exit("east","/wizards/trooper/areas/rohelm/r15.c");
  add_exit("south","/wizards/trooper/areas/rohelm/r2.c");
  add_exit("west","/wizards/trooper/areas/rohelm/r13.c");
