...
reset(arg) {
  add_exit("north","/wizards/trooper/areas/rohelm/r28.c");
  add_exit("east","/wizards/trooper/areas/rohelm/r17.c");
  add_exit("south","/wizards/trooper/areas/rohelm/r4.c");
  add_exit("west","/wizards/trooper/areas/rohelm/r15.c");
