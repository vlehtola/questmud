...
reset(arg) {
  add_exit("north","/wizards/trooper/areas/rohelm/r29.c");
  add_exit("east","/wizards/trooper/areas/rohelm/r18.c");
  add_exit("south","/wizards/trooper/areas/rohelm/r5.c");
  add_exit("west","/wizards/trooper/areas/rohelm/r16.c");
