...
reset(arg) {
  add_exit("north","/wizards/trooper/areas/rohelm/r30.c");
  add_exit("east","/wizards/trooper/areas/rohelm/r19.c");
  add_exit("south","/wizards/trooper/areas/rohelm/r6.c");
  add_exit("west","/wizards/trooper/areas/rohelm/r17.c");
