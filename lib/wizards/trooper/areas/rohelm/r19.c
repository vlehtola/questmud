...
reset(arg) {
  add_exit("north","/wizards/trooper/areas/rohelm/r31.c");
  add_exit("east","/wizards/trooper/areas/rohelm/r20.c");
  add_exit("south","/wizards/trooper/areas/rohelm/r7.c");
  add_exit("west","/wizards/trooper/areas/rohelm/r18.c");
