...
reset(arg) {
  add_exit("north","/wizards/trooper/areas/rohelm/r34.c");
  add_exit("east","/wizards/trooper/areas/rohelm/r23.c");
  add_exit("south","/wizards/trooper/areas/rohelm/r10.c");
  add_exit("west","/wizards/trooper/areas/rohelm/r21.c");
