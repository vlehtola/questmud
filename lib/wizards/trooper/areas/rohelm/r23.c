...
reset(arg) {
  add_exit("north","/wizards/trooper/areas/rohelm/r35.c");
  add_exit("east","/wizards/trooper/areas/rohelm/r24.c");
  add_exit("south","/wizards/trooper/areas/rohelm/r11.c");
  add_exit("west","/wizards/trooper/areas/rohelm/r22.c");
