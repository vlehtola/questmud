...
reset(arg) {
  add_exit("north","/wizards/trooper/areas/rohelm/r36.c");
  add_exit("east","/wizards/trooper/areas/rohelm/r25.c");
  add_exit("south","/wizards/trooper/areas/rohelm/r12.c");
  add_exit("west","/wizards/trooper/areas/rohelm/r23.c");
