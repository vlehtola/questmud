...
reset(arg) {
  add_exit("north","/wizards/trooper/areas/rohelm/r38.c");
  add_exit("east","/wizards/trooper/areas/rohelm/r27.c");
  add_exit("south","/wizards/trooper/areas/rohelm/r14.c");
  add_exit("west","/wizards/trooper/areas/rohelm/r25.c");
