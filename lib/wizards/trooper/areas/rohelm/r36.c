...
reset(arg) {
  add_exit("east","/wizards/trooper/areas/rohelm/r37.c");
  add_exit("south","/wizards/trooper/areas/rohelm/r24.c");
  add_exit("west","/wizards/trooper/areas/rohelm/r35.c");
  add_exit("north","/wizards/trooper/areas/rohelm/r39.c");
