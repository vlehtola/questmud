...
reset(arg) {
  add_exit("south","/wizards/trooper/areas/rohelm/entrance.c");
  add_exit("north","/wizards/trooper/areas/rohelm/r21.c");
  add_exit("west","/wizards/trooper/areas/rohelm/r7.c");
  add_exit("east","/wizards/trooper/areas/rohelm/r9.c");
