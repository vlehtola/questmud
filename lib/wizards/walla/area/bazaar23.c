...
THREE_EXIT("wizards/walla/area/bazaar33", "south",
         "wizards/walla/area/bazaar22", "west",
         "wizards/walla/area/bazaar13", "north",
"In the bazaar of Jericho",
         "You are in the eastern part of the bazaar.\n" +
