...
if(!guard1) {
  ...
  if(!guard2) {
    guard2 = clone_object("/wizards/walla/jericho/mobs/bblocker");
    move_object(guard2, this_object());
  }
 
  
  add_exit("north","wizards/walla/jericho/rooms/leblair/leblair3");
  add_exit("south","wizards/walla/jericho/rooms/leblair/leblair1");
