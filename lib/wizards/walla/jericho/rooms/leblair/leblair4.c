...
if(arg) return;  
if(!guard1) {
    guard1 = clone_object("/wizards/walla/jericho/mobs/bblocker");
  ...
  add_exit("north","wizards/walla/jericho/rooms/leblair/leblair5");
  add_exit("south","wizards/walla/jericho/rooms/leblair/leblair3");
