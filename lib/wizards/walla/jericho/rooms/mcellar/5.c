...
reset(arg) {
  ...
  add_exit("west","/wizards/walla/jericho/rooms/mcellar/6");
  add_exit("east","/wizards/walla/jericho/rooms/mcellar/4");
  add_exit("north","/wizards/walla/jericho/rooms/mcellar/c2");
  add_exit("south","/wizards/walla/jericho/rooms/mcellar/c6");
