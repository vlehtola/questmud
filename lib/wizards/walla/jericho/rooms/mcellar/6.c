...
reset(arg) {
  ...
  add_exit("west","/wizards/walla/jericho/rooms/mcellar/c4");
  add_exit("east","/wizards/walla/jericho/rooms/mcellar/5");
  add_exit("north","/wizards/walla/jericho/rooms/mcellar/c3");
  add_exit("south","/wizards/walla/jericho/rooms/mcellar/c5");
