...
reset(arg) {
  ...
  if(arg) return;
  add_exit("west","wizards/walla/jericho/rooms/ispep5");
  add_exit("up","wizards/walla/jericho/rooms/towers/e2");
  short_desc = "At the bottom of a huge stairwell";
  long_desc =
"You are standing at the bottom of some stairs, leading upwards, to the top\n" +
"of the eastern guardtower. In front of the stairwell stands a monster of\n" +
