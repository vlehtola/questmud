...
reset(arg) {
  ...
  if(arg) return;
  add_exit("southwest","wizards/walla/jericho/rooms/htorn5");
  add_exit("up","wizards/walla/jericho/rooms/towers/ne2");
  short_desc = "At the bottom of a huge stairwell";
  long_desc =
"You are standing at the bottom of some stairs, leading upwards, to the top\n" +
"of the northeastern guardtower. In front of the stairwell stands a monster of\n" +
