...
reset(arg) {
  ...
  if(arg) return;
  add_exit("northwest","wizards/walla/jericho/rooms/htuos5");
  add_exit("up","wizards/walla/jericho/rooms/towers/se2");
  short_desc = "At the bottom of a huge stairwell";
  long_desc =
"You are standing at the bottom of some stairs, leading upwards, to the top\n" +
"of the southeastern guardtower. In front of the stairwell stands a monster of\n" +
