...
reset(arg) {
  ...
  if(arg) return;
  add_exit("east","wizards/walla/jericho/rooms/ispep-5");
  add_exit("up","wizards/walla/jericho/rooms/towers/w2");
  short_desc = "At the bottom of a huge stairwell";
  long_desc =
"You are standing at the bottom of some stairs, leading upwards, to the top\n" +
"of the western guardtower. In front of the stairwell stands a monster of\n" +
