...
check_rooms(string str) {
  ...
  if (str == "c") return clone_object("/wizards/walla/lemmings/rooms/lvl2/cave");
  if (str == "X") return clone_object("/wizards/walla/lemmings/rooms/lvl2/pillar");

}

check_special_coords(x,y) {
  if(x == 16 && y == 19) return "/wizards/walla/lemmings/rooms/shared/2stairs";
  return 0;
}
