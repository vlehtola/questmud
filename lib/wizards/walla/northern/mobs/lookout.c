...
reset(arg) {
    ...
    if (!chat_str) {
        chat_str = allocate(3);
        chat_str[0] =
          "Lookout peers out the window.\n";
        chat_str[1] =
          "Lookout scratches his head and mutters about someone moving in the valley.\n";
        chat_str[2] =
          "Lookout mutters something about the chilling wind.\n";
