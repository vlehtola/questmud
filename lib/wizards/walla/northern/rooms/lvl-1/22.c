...
reset(arg) {
  ...
  add_exit("north","/wizards/walla/northern/rooms/lvl-1/23");
  add_exit("west","/wizards/walla/northern/rooms/lvl-1/21");
  add_exit("south","/wizards/walla/northern/rooms/lvl-1/24");
