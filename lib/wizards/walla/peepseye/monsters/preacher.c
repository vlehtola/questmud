...
reset(arg) {
    ...
    ::reset(arg);
    if(arg) { return; }
   call_other(this_object(), "set_name", "preacher");
    call_other(this_object(), "set_alias", "james");
    call_other(this_object(), "set_short", "A preacher, looking just like James Brown, preaching in his winered robe");
    call_other(this_object(), "set_long", "You see before you, the silhouette of a great man, no perhaps in size, but\n"+
                "sure enough in knowledge of the divine way. He seems to be happy that\n"+
