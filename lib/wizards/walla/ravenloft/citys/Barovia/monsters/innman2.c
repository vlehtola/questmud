...
reset(arg) {
    ...
    call_other(this_object(), "set_name", "Ivan");
    call_other(this_object(), "set_alias", "drunkard");
    call_other(this_object(), "set_short", "Ivan, the storyteller laughs and laughs again");
    call_other(this_object(), "set_long", "As Ivan tells a joke, everyone laughs, perhaps\n" +
                                          "only not to make Ivan unhappy because seriously speaking his\n" +
                                          "jokes suck.\n");
    ...
    set_skill("mastery of electricity", 100);
     ...
     if (!chat_str) {   
        chat_str = allocate(8);
        chat_str[0] =
          "Ivan says: I remember a place like this... Sri Lanka, formerly Ceylon...\n";
        chat_str[1] =
          "Ivan says: I got one, Why did NASA kidnapp blondes ? Because they are doing researches on black holes.\n";
        chat_str[2] =
