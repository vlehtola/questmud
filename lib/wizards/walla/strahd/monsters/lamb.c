...
reset(arg) {
    ...
    call_other(this_object(), "set_short", "A happy little lamb, nagging the grass");
    call_other(this_object(), "set_long", "The lamb eats some grass but seems to stay away from \n" + 
