...
string short() {
    return "A huge cauldron burning with eternal fire.";
}
 
void long() {
    write("This is a huge cauldron, that burns in the middle of the\n");
    write("templeyard. It burns with a bright light, and releases some\n");
    write("soothing smoke, which makes you feel warm and relaxed inside.\n");
}
