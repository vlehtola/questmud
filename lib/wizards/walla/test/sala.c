...
search(str) {
 ...
 THREE_EXIT( "/wizards/walla/area2/rooms/temple/in/ylakeski", "west",
           "wizards/walla/area2/rooms/temple/in/oikeakeski", "south",
           "wizards/walla/area2/rooms/temple/in/keski", "southwest",
           "In the courtyard",
           "You are standing in the courtyard, which is surrounded by\n" +         
           "great walls. The walls are almost 50 feet high, and there is\n" +
