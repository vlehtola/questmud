...
case "mastery of meditation": return 4;
 ...
 case "whirling slash": return 6;
 case "vital points": return 7;
 case "crushing": return 7;
 case "finishing move": return 7;
...
case "soul heal": return 2;
case "bear_mastery": return 10;
case "summon bear": return 10;
...
case "razor wings": return 8;
case "knowledge of the fists": return 9;
case "lightning reflexes": return 9;
case "tigers punch": return 6;
case "head bang": return 5;
case "wind strike": return 7;

//Shapeshifters by Moonstar (testing phaze)
  case "chant of bears": return 3;
  case "animal instinct": return 3;
  case "animals strength": return 3;
  case "shapeshift control": return 3;
  case "double claws": return 3;
  case "combined claw strike": return 3;
  case "mastery of shapeshifting": return 3;
  case "bear hug": return 3;
  case "bear strike": return 3;
  case "bear blow": return 3;
  case "animals will": return 3;
  case "double blow": return 3;
  case "power hug": return 3;
  case "double bear strike": return 3;
...
//sorcerers juttuu moonstar&rimber
  case "recharge staff": return 2;
  case "sorcerers touch": return 3;
  case "eyes of phoenix": return 3;
  case "focused will": return 7;
  case "powered will": return 8;
  case "mind link": return 6;
  case "faith of izyldran": return 8;
  case "trance": return 4;
  case "faith of grizz": return 9;
  case "faith of ratoma": return 9;
  case "faith of anrax": return 9;
  case "smack": return 3;
  case "mind critical": return 8;
  case "staff handling": return 3;
  case "knowledge of power": return 8;
  }
  if(class == 3) { return 0; }
  switch(skill) {
  ...
  case "cast transfer":return 3;
  case "cast heal":return 3;
  case "cast alignment":return 3;
  case "cast bless":return 5;
  case "cast soul":return 7;
  case "cast divine":return 3;
  case "cast minor":return 3;
  case "cast lesser":return 5;
  case "cast major":return 8;
  case "cast wide":return 8;
  case "cast satisfy": return 3;
  case "cast gender": return 5;
  ...
  case "cast force": return 3;

  case "call angel": return 8;
...
//sorcerers juttuu moonstar&rimber
  case "cast will": return 2;
  case "cast minor ztrand": return 3;
  case "cast wounding": return 4;
  case "cast soul chaining": return 5;
  case "cast ztrand": return 4;
  case "cast major ztrand": return 5;
  case "path of the will": return 3;
  case "aurabeam": return 8;
  case "meteor storm": return 9;
  case "move items": return 6;
  case "wrath of phoenix": return 9;
  case "cry of phoenix": return 7;
  case "ice meteor": return 9;
  case "bless of grizz": return 7;
  case "grasp of ratoma": return 9;
  case "teleport": return 7;
  case "soul curse": return 7;
  case "gods aura": return 6;
  case "shield of will": return 7;
  case "will change": return 6;
