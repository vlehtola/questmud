...
reset(status arg) {
  ...
  long_desc =
"The Adventurers' hall deserves its reputation as travellers' favorite\n"+
...
uses.\n\n";*/
  ...
  add_exit("up", "/world/city/questroom.c");
  if(!i) {
    call_out("tick", 12);
    i = 1;
  }
  ...
  move_object(clone_object("/daemons/mudboard"), this_object());
