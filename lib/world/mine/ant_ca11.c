...
extra_reset() {    
    ...
    if (!ant3 || !living(ant3)) {
	ant3 = clone_object("world/monsters/ant1.c");
	move_object(ant3, this_object());
    }
    if (!ant4 || !living(ant4)) {
	ant4 = clone_object("world/monsters/ant2.c");
	move_object(ant4, this_object());
    }
    set_not_out(1);
}
...
THREE_EXIT("world/mine/ant_ca13", "west",
	 "world/mine/ant_ca10", "south",        
	 "world/mine/ant_cav9", "east",        
	 "Ant cave",
