...
reset(arg) {
	...
	set_long("A beautiful fountain made of white marble full of decorations and pictures.\n"+
                 "A fresh and clear looking water is constantly flowing from the hands of small\n"+
                 "statue");
